...
export default function LoginPage() {
    return (
        <div className="min-h-screen bg-[#0A1628] flex items-center justify-center p-6 pt-32 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#C6A75E]/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2" />
            ...
            >
                {/* Branding Side */}
                <div className="hidden md:flex md:w-[45%] bg-[#C6A75E] p-16 flex-col justify-between items-start relative overflow-hidden text-[#0A1628]">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-[#0A1628] rounded-xl flex items-center justify-center text-[#C6A75E]">
                            <Building2 />
                        </div>
                ...
                <div className="flex-1 p-12 md:p-20 flex flex-col justify-center">
                    ...
                    <form className="space-y-8">
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-6 pl-16 pr-8 text-white focus:ring-2 focus:ring-[#C6A75E] outline-none transition-all placeholder:text-white/10 font-light"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center px-1">
                                ...
                                <a href="#" className="text-[10px] uppercase font-bold tracking-widest text-[#C6A75E] hover:text-white transition-colors">Forgot?</a>
                            </div>
                            <div className="relative">
                                ...
                                <input
                                    type="password"
                                    placeholder="••••••••"
                                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-6 pl-16 pr-8 text-white focus:ring-2 focus:ring-[#C6A75E] outline-none transition-all placeholder:text-white/10"
                                />
                            </div>
                        </div>
                    ...
                    <div className="mt-12 pt-8 border-t border-white/5 flex flex-wrap gap-8 justify-center">
                        <Link href="/contact" className="text-[10px] uppercase font-bold tracking-widest text-white/20 hover:text-[#C6A75E] transition-colors">Support</Link>
                        <Link href="/rules/conduct" className="text-[10px] uppercase font-bold tracking-widest text-white/20 hover:text-[#C6A75E] transition-colors">Privacy Policy</Link>
                    </div>
                </div>
            </motion.div>
        </div>
