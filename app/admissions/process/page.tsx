    ...
    return (
        <main>
                ...
                <div className="container-premium">
                    <div className="grid lg:grid-cols-4 gap-8">
                        {steps.map((step, idx) => (
                            ...
                            >
                                <div className="p-10 bg-white rounded-[48px] border border-[#0A1628]/5 shadow-sm hover:shadow-[#C6A75E]/10 transition-all duration-500 h-full flex flex-col">
                                    <div className="w-16 h-16 bg-[#0A1628] rounded-2xl flex items-center justify-center text-[#C6A75E] mb-8 group-hover:scale-110 transition-transform duration-500">
                                        {step.icon}
                                    </div>
                                    ...
                                    {idx < steps.length - 1 && (
                                        <div className="absolute -right-4 top-1/2 -translate-y-1/2 hidden lg:block text-[#C6A75E]/20">
                                            <ArrowRight size={48} />
                                        </div>
                                    )}
                                </div>
            ...
            <ContentSection alternate title="Essential Documents" subtitle="CHECKLIST">
                <div className="bg-white rounded-[64px] p-12 md:p-20 shadow-xl grid md:grid-cols-2 gap-12">
                    ...
                    <div className="flex flex-col justify-center items-center text-center space-y-8 p-12 bg-[#0A1628] rounded-[48px] text-white">
                        <h5 className="text-2xl font-display font-medium text-[#C6A75E]">Ready to start?</h5>
